 ...
 *  shapes. Depends on nothing — apodict included. */
 ...
 *  an unbound placeholder. Returns apodict assume-entry objects
...
/** Build an apodict `declare` object: each query symbol gets the flags the
